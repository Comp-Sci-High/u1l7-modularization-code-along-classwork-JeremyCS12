...
function describeHero(hero,power,city){
    return hero + " uses " + power + " to protect " + city + ".";
}


// Step 4: Call the function below for Spider-Man, Magneto, & Wonder Woman
console.log(describeHero("Spider-Man", "web-slinging", "New York"));
console.log(describeHero("Magneto", "magnetic field manipulation", "Genosha"));
console.log(describeHero("Wonder Woman", "super strenth", "Themyscira"));
...
console.log(describeHero("Super-Man", "super strenth", "hemyscira"));
console.log(describeHero("Thor", "Power of god", "Asgard"));
...
function describeVillians (Villain, Location, Chaos) {
    return Villain + " has escaped from the Raft and is causing chaos in " + Location + " by " + Chaos + "!";
}

console.log(describeVillians("Doctor Octopus", "Times Square", "destroying cars with his mechanical arms"));
console.log(describeVillians("Electro", "Central Park", "overloading the city's power grid"));
console.log(describeVillians("Vulture", "Empire State Building", "swooping down and grabbing people off the streets"));
console.log(describeVillians("SandMan", "Brooklyn Bridge", "turning the bridge into sand"));
console.log(describeVillians("Mysterio", "Broadway", "casting illusions to confuse and panic everyone"));
...
console.log(describeVillians("Kraven the Hunter", "Bronx Zoo", "releasing and hunting wild animals"));
...
function superHeroCollection (secretIdentity, city, affiliation, archNemesis, catchPhrase) {
    return {
...
console.log(superHeroCollection("T'Challa", "Wakanda", "Avengers", "Killmonger", "Wakanda Forever"))
console.log(superHeroCollection("Bruce Wayne", "Gotham City", "Justice League", "Joker", "I am vengeance, I am the night, I am Batman"))
...
console.log(superHeroCollection("Tony Stark", "NYC", "Avengers", "Mandarin", "I am Iron Man"))
